...
w=49.5e-6
l=25e-6
lvs_format="tcleval(@name @pinlist @model A=1215.225p P=148.1u )"
}
...
w=0.3e-6
l=49.5e-6
lvs_format="tcleval(@name @pinlist @model A=14.85p P=99.6u )"
}
...
w=49.5e-6
l=25e-6
lvs_format="tcleval(@name @pinlist @model A=1215.72p P=148.12u )"
}
...
w=49.5e-6
l=25e-6
lvs_format="tcleval(@name @pinlist @model A=1190.97p P=147.12u )"
}
