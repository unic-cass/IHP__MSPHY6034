...
w=1.56e-6
l=24.5e-6
lvs_format="tcleval(@name @pinlist @model A=38.298p P=52.22u )"
}
...
w=0.42e-6
l=1.6e-6
lvs_format="tcleval(@name @pinlist @model A=0.672p P=5.08u )"
}
...
w=1.56e-6
l=24.5e-6
lvs_format="tcleval(@name @pinlist @model A=38.3136p P=52.24u )"
}
...
w=1.56e-6
l=24.5e-6
lvs_format="tcleval(@name @pinlist @model A=37.5336p P=51.24u )"
}
