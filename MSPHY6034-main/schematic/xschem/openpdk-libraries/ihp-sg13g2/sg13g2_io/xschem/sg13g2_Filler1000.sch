...
w=4.4e-6
l=25e-6
lvs_format="tcleval(@name @pinlist @model A=110.475p P=58.1u )"
}
...
w=0.31e-6
l=4.56e-6
lvs_format="tcleval(@name @pinlist @model A=1.368p P=9.72u )"
}
...
w=4.4e-6
l=25e-6
lvs_format="tcleval(@name @pinlist @model A=110.52p P=58.12u )"
}
...
w=4.4e-6
l=25e-6
lvs_format="tcleval(@name @pinlist @model A=108.27p P=57.12u )"
}
