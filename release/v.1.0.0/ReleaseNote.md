...
- **Top** — team4 chip integration (`team4_chip_top`): padring + sub-IP
  integration. `gds/team4_chip_top.gds`, `netlist/team4_chip_top.spice`,
  `doc/team4_chip_top.sch`. Padring source in `MSPHY6034-main/`.
